...
inline jlong OrgOssPdfreporterEngineDesignJRDesignTextElement_get_serialVersionUID();
#define OrgOssPdfreporterEngineDesignJRDesignTextElement_serialVersionUID 10200LL
J2OBJC_STATIC_FIELD_CONSTANT(OrgOssPdfreporterEngineDesignJRDesignTextElement, serialVersionUID, jlong)
...
- (void)setFontWithOrgOssPdfreporterEngineJRFont:(id<OrgOssPdfreporterEngineJRFont>)font {
  ...
  [self setBoldWithJavaLangBoolean:[font isOwnBold]];
  [self setItalicWithJavaLangBoolean:[font isOwnItalic]];
  [self setUnderlineWithJavaLangBoolean:[font isOwnUnderline]];
  [self setStrikeThroughWithJavaLangBoolean:[font isOwnStrikeThrough]];
  [self setFontSizeWithJavaLangInteger:[font getOwnFontSize]];
  [self setPdfFontNameWithNSString:[font getOwnPdfFontName]];
  [self setPdfEncodingWithNSString:[font getOwnPdfEncoding]];
  [self setPdfEmbeddedWithJavaLangBoolean:[font isOwnPdfEmbedded]];
}
...
- (id)clone {
  OrgOssPdfreporterEngineDesignJRDesignTextElement *clone = (OrgOssPdfreporterEngineDesignJRDesignTextElement *) cast_chk([super clone], [OrgOssPdfreporterEngineDesignJRDesignTextElement class]);
  ((OrgOssPdfreporterEngineDesignJRDesignTextElement *) nil_chk(clone))->lineBox_ = [((id<OrgOssPdfreporterEngineJRLineBox>) nil_chk(lineBox_)) cloneWithOrgOssPdfreporterEngineJRBoxContainer:clone];
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgOssPdfreporterEngineJRDefaultStyleProvider:", "JRDesignTextElement", NULL, 0x4, NULL, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "serialVersionUID", "serialVersionUID", 0x1a, "J", NULL, NULL, .constantValue.asLong = OrgOssPdfreporterEngineDesignJRDesignTextElement_serialVersionUID },
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterEngineDesignJRDesignTextElement = { 2, "JRDesignTextElement", "org.oss.pdfreporter.engine.design", NULL, 0x401, 56, methods, 16, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterEngineDesignJRDesignTextElement;
}

@end

void OrgOssPdfreporterEngineDesignJRDesignTextElement_initWithOrgOssPdfreporterEngineJRDefaultStyleProvider_(OrgOssPdfreporterEngineDesignJRDesignTextElement *self, id<OrgOssPdfreporterEngineJRDefaultStyleProvider> defaultStyleProvider) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterEngineDesignJRDesignTextElement)
