...
@implementation OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract_init(self);
  return self;
}
...
- (id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>)executeWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:(id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>)a
  ...
  switch ([evaluatesTo ordinal]) {
    ...
    return OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionArgumentFactory_createObjectWithJavaMathBigDecimal_([((JavaMathBigDecimal *) nil_chk([self getBigDecimalWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:a])) subtractWithJavaMathBigDecimal:[self getBigDecimalWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:b]]);
    default:
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@$@", @"Unsupported subtract operation for the types ", [((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(a)) getType], @" and ", [((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(b)) getType], @" for expected evaluation to ", evaluatesTo));
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "Subtract", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract = { 2, "Subtract", "org.oss.pdfreporter.uses.org.oss.jshuntingyard.evaluator.operator.primitive", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract;
}

@end

void OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract_init(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract *self) {
...
OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract *new_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract, init)
}

OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract *create_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveSubtract)
