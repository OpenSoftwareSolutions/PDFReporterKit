...
@implementation OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd_init(self);
  return self;
}
...
- (id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>)executeWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:(id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>)a
  ...
  switch ([evaluatesTo ordinal]) {
    case OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument_ArgumentType_Enum_STRING:
    return OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionArgumentFactory_createStringWithNSString_(JreStrcat("$$", [((id) nil_chk([((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(a)) getValue])) description], [((id) nil_chk([((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(b)) getValue])) description]));
    ...
    return OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionArgumentFactory_createObjectWithJavaMathBigDecimal_([((JavaMathBigDecimal *) nil_chk([self getBigDecimalWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:a])) addWithJavaMathBigDecimal:[self getBigDecimalWithOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument:b]]);
    default:
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$@$@", @"Unsupported add operation for the types ", [((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(a)) getType], @" and ", [((id<OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElementArgument>) nil_chk(b)) getType], @" for expected evaluation to ", evaluatesTo));
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd = { 2, "Add", "org.oss.pdfreporter.uses.org.oss.jshuntingyard.evaluator.operator.primitive", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd;
}

@end

void OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd_init(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd *self) {
...
OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd *new_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd, init)
}

OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd *create_OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorOperatorPrimitiveAdd)
