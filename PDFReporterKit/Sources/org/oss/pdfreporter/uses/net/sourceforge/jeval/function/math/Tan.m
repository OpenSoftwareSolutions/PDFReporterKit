...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  result = new_JavaLangDouble_initWithDouble_(JavaLangMath_tanWithDouble_([((JavaLangDouble *) nil_chk(number)) doubleValue]));
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan = { 2, "Tan", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathTan)
