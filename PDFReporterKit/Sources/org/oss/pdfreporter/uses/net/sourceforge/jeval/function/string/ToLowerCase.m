...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  @try {
    ...
    result = [((NSString *) nil_chk(argumentOne)) lowercaseString];
  }
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase = { 2, "ToLowerCase", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.string", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringToLowerCase)
