...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  @try {
    ...
    if ([((NSString *) nil_chk(argumentOne)) hasPrefix:argumentTwo offset:index]) {
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith = { 2, "StartsWith", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.string", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringStartsWith)
