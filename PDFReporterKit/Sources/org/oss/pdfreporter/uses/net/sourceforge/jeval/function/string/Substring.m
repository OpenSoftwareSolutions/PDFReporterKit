...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  JavaUtilArrayList *values = OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionHelper_getOneStringAndTwoIntegersWithNSString_withChar_(arguments, OrgOssPdfreporterUsesNetSourceforgeJevalEvaluationConstants_FUNCTION_ARGUMENT_SEPARATOR);
  ...
  @try {
    ...
    jint beginningIndex = [((JavaLangInteger *) nil_chk(((JavaLangInteger *) cast_chk([values getWithInt:1], [JavaLangInteger class])))) intValue];
    jint endingIndex = [((JavaLangInteger *) nil_chk(((JavaLangInteger *) cast_chk([values getWithInt:2], [JavaLangInteger class])))) intValue];
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring = { 2, "Substring", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.string", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringSubstring)
