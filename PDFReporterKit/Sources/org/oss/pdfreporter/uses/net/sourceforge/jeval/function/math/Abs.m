...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  result = new_JavaLangDouble_initWithDouble_(JavaLangMath_absWithDouble_([((JavaLangDouble *) nil_chk(number)) doubleValue]));
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs = { 2, "Abs", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAbs)
