...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  result = new_JavaLangDouble_initWithDouble_(JavaLangMath_rintWithDouble_([((JavaLangDouble *) nil_chk(number)) doubleValue]));
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint = { 2, "Rint", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathRint)
