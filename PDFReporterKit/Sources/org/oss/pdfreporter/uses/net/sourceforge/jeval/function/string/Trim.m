...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "init", "Trim", NULL, 0x1, NULL, NULL },
  };
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim = { 2, "Trim", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.string", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionStringTrim)
