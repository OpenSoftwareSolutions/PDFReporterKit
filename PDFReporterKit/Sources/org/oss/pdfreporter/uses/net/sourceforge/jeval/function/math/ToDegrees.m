...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  result = new_JavaLangDouble_initWithDouble_(JavaLangMath_toDegreesWithDouble_([((JavaLangDouble *) nil_chk(number)) doubleValue]));
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees = { 2, "ToDegrees", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathToDegrees)
