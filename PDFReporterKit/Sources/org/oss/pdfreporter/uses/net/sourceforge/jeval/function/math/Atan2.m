...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  @try {
    ...
    result = new_JavaLangDouble_initWithDouble_(JavaLangMath_atan2WithDouble_withDouble_(argumentOne, argumentTwo));
  }
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2 = { 2, "Atan2", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2 *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2 *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2 *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAtan2)
