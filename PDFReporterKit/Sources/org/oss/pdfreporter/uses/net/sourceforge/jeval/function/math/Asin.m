...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  result = new_JavaLangDouble_initWithDouble_(JavaLangMath_asinWithDouble_([((JavaLangDouble *) nil_chk(number)) doubleValue]));
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin = { 2, "Asin", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathAsin)
