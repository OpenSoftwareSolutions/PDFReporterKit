...
@implementation OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax
...
- (OrgOssPdfreporterUsesNetSourceforgeJevalFunctionFunctionResult *)executeWithOrgOssPdfreporterUsesNetSourceforgeJevalEvaluator:(OrgOssPdfreporterUsesNetSourceforgeJevalEvaluator *)evaluator
  ...
  @try {
    ...
    result = new_JavaLangDouble_initWithDouble_(JavaLangMath_maxWithDouble_withDouble_(argumentOne, argumentTwo));
  }
...
- (instancetype)init {
  OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax = { 2, "Max", "org.oss.pdfreporter.uses.net.sourceforge.jeval.function.math", NULL, 0x1, 3, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax;
}

@end

void OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax_init(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax *self) {
  NSObject_init(self);
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax *new_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax, init)
}

OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax *create_OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterUsesNetSourceforgeJevalFunctionMathMax)
