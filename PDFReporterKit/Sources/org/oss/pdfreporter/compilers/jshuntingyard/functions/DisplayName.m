...
@implementation OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName_init(self);
  return self;
}
...
void OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName_init(OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName *self) {
  OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorAbstractOneArgFunctionElement_initWithNSString_withOrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElement_Precedence_(self, @"displayName", JreLoadEnum(OrgOssPdfreporterUsesOrgOssJshuntingyardEvaluatorFunctionElement_Precedence, USERFUNCTION));
}

OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName *new_OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName_init() {
  J2OBJC_NEW_IMPL(OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName, init)
}

OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName *create_OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName_init() {
  J2OBJC_CREATE_IMPL(OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgOssPdfreporterCompilersJshuntingyardFunctionsDisplayName)
